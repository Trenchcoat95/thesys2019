...
\end{align}
The equations of motion can now be re-written to be divided between the plane $y'z$ and the plane $\rho z$:
\begin{equation}
\begin{cases}
x=x_0+\rho\tan\lambda\\
...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{0.475\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{\label{fiducialefficiency:fig}(a) Energy (Monte Carlo truth) distribution of neutrinos from the CC nominal sample (grey); Energy (Monte Carlo truth) distribution of neutrinos surviving the fiducial cut (yellow). (b) Selection efficiency as a function of neutrino energy from the Monte Carlo truth.} 
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.475\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{\label{ev:fig}Evolution of the values of (a) $\chi^2$, (b) p-value and (c) confidence level in number of sigmas for increasingly larger samples where all the cuts were applied. On the abscissa we show the size of the total event sample before any cut was applied.} 
\end{figure}
\clearpage
...
\bibitem{tracking} A.Andreazza, ``Tracking Systems", Lecture notes from ``Acceleratori di Particelle", Dipartimento di Fisica, Università degli studi di Milano, http://www2.fisica.unimi.it/andreazz/AA\_TrackingSystems.pdf
...
\bibitem{KS} Pratt, John W.
and Gibbons, Jean D, ``Kolmogorov-Smirnov Two-Sample Tests", in "Concepts of Nonparametric Theory",1981, Springer New York, New York, NY, 318--344.
\bibitem{AD general}M, Arshad  M.T, Rasool  Ahmad, Muhammad. (2003). ``Anderson Darling and Modified Anderson Darling Tests for Generalized Pareto Distribution". Journal of Applied Sciences. 3(2). 10.3923/jas.2003.85.88. 
